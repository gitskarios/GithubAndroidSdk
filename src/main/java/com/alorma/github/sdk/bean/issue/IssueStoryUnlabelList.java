 ...
 */
public class IssueStoryUnlabelList extends ArrayList<Label> implements IssueStoryDetail, Parcelable {

    public static final Parcelable.Creator<IssueStoryUnlabelList> CREATOR = new Parcelable.Creator<IssueStoryUnlabelList>() {
