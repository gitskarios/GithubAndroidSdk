 ...
 */
public class PullRequestStoryCommitsList extends ArrayList<Commit> implements IssueStoryDetail, Parcelable {

    public static final Parcelable.Creator<PullRequestStoryCommitsList> CREATOR = new Parcelable.Creator<PullRequestStoryCommitsList>() {
