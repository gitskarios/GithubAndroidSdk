...
public interface RepoActionsService {
  ...
  Observable<Repo> forkRepo(@Path("owner") String owner, @Path("repo") String repo, @Body Object empty);

  @Headers("Content-Length: 0")
  @POST("/repos/{owner}/{repo}/forks")
  Observable<Repo> forkRepo(@Path("owner") String owner, @Path("repo") String repo, @Query("organization") String org, @Body Object empty);
}
