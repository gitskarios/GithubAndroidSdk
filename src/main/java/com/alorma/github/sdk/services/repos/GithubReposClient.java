...
public abstract class GithubReposClient extends GithubListClient<List<Repo>> {
  ...
  protected abstract void executeFirstPageByUsername(String username, String sort,
  ...
  protected abstract void executePaginatedByUsername(String username, int page, String sort,
      ReposService usersService, ApiSubscriber apiSubscriber);
}
