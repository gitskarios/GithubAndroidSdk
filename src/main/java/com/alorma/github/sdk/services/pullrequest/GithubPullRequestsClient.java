 ...
 */
public abstract class GithubPullRequestsClient<K> extends GithubClient<K> {
    private String owner;
    private String repository;
	private int num;
	private int page;

    public GithubPullRequestsClient(Context context, String owner, String repository) {
        super(context);
        this.owner = owner;
	...
	public GithubPullRequestsClient(Context context, String owner, String repository, int page) {
