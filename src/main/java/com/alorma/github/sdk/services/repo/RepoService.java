...
public interface RepoService {
    ...
    @GET("/repos/{owner}/{name}/contents/{path}")
    void contentsByRef(@Path("owner") String owner, @Path("name") String repo, @Path("path") String path, @Query("ref") String ref,
    ...
    @GET("/repos/{owner}/{name}/forks")
    void listForks(@Path("owner") String owner, @Path("name") String repo, @Query("sort") String sort, @Query("page") int page,
                   Callback<List<Repo>> callback);

    @GET("/repos/{owner}/{name}/commits/{ref}/status")
    void combinedStatusASync(@Path("owner") String owner, @Path("name") String repo, @Path("ref") String ref,
    ...
    Observable<CompareCommit> compareCommits(@Path("owner") String owner, @Path("name") String repo, @Path("base") String base,
    ...
    Observable<Repo> edit(@Path("owner") String owner, @Path("name") String repo, @Body RepoRequestDTO repoRequestDTO);
    ...
    @GET("/repos/{owner}/{name}/commits/{ref}/status")
    Observable<GithubStatusResponse> combinedStatus(@Path("owner") String owner, @Path("name") String repo, @Path("ref") String ref);
    ...
    @GET("/repos/{owner}/{name}/commits/{ref}/status")
    GithubStatusResponse combinedStatusSync(@Path("owner") String owner, @Path("name") String repo, @Path("ref") String ref);
