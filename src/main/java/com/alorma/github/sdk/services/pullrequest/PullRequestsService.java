...
public interface PullRequestsService {
  ...
  @GET("/repos/{owner}/{name}/pulls")
  void pulls(@Path("owner") String owner, @Path("name") String repo, @Query("state") String state, @Query("page") int page,
  ...
  @GET("/repos/{owner}/{repo}/pulls/{number}/commits")
  void commits(@Path("owner") String owner, @Path("repo") String repo, @Path("number") int number, @Query("page") int page,
  ...
  @GET("/repos/{owner}/{repo}/pulls/{number}/files")
  void files(@Path("owner") String owner, @Path("repo") String repo, @Path("number") int number, @Query("page") int page,
  ...
  void reviewComments(@Path("owner") String owner, @Path("repo") String repo, @Path("number") int number,
      Callback<List<ReviewComment>> callback);

  @GET("/repos/{owner}/{repo}/pulls/{number}/comments")
  void reviewComments(@Path("owner") String owner, @Path("repo") String repo, @Path("number") int number, @Query("page") int page,
      Callback<List<ReviewComment>> callback);
  ...
  @PUT("/repos/{owner}/{repo}/pulls/{number}/merge")
  Observable<MergeButtonResponse> merge(@Path("owner") String owner, @Path("repo") String repo, @Path("number") int number,
      @Body MergeButtonRequest mergeButtonRequest);
